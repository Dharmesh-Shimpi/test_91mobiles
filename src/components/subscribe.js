...
export default function Subscribe() {
	return (
		<div
			className={`${css.svg} w-full py-10 rounded-lg flex flex-col justify-center items-center`}
		>
			...
			<form className="bg-white rounded-lg flex flex-col sm:flex-row md:flex-row lg:flex-row justify-evenly items-center lg:w-3/4 md:w-full sm:w-full min-h-fit p-4">
				<input
					type="email"
