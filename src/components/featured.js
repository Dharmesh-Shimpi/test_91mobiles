...
export default function Featured() {
	return (
		<section className="w-full p-5 flex justify-center items-center bg-slate-100">
			<div className="flex md:flex-row lg:flex-row sm:flex-col phone-lg:flex-col phone-md:flex-col phone-sm:flex-col justify-between items-center overflow-scroll">
				{/* Featured Section */}
				...
				<div className="m-1 flex flex-col items-center">
					...
					<div className="flex flex-wrap justify-center h-auto w-full">
						{json.map((item, index) => (
							<div
								key={index}
								className="relative overflow-hidden rounded-xl border p-1 m-2 md:h-[200px] md:w-[300px] phone-lg:h-[180px] phone-lg:w-[230px] phone-md:h-[150px] phone-md:w-[200px] phone-sm:h-[120px] phone-sm:w-[180px]"
							>
								<img
									src={item.img}
									alt={item.desc}
								...
								/>
								<div className="flex justify-end items-start flex-col absolute bottom-0 left-0 w-full p-2 h-full bg-gradient-to-t from-black">
									<div className="p-2 text-white text-xs phone-lg:text-xxs phone-md:text-xxs phone-sm:text-xxs">
										{item.desc}
									</div>
									<div className="text-white text-xs phone-lg:text-xxs phone-md:text-xxs phone-sm:text-xxs p-2">
										{item.text}
